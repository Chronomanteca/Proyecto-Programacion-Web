...
import com.example.proyectoprogramacionweb.Shared.Domain.Bus.Event.RabbitMQ.Serializable.DomainEventJsonDeserializer;
...
public class RabbitMqDomainEventsConsumer {
    ...
    public void consume(Message message) throws Exception {
        ...
        try {
            ...
            System.err.println("Error: " + error.toString() + "caused: " + error.getCause());
        }
    }
